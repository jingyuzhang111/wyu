...
public static class ZapbotVisualReplacePatch
{
    private const string TargetMonsterId = "ZAPBOT";
    private const string CustomScenePath = "res://wyu/Scenes/creatureVisual/zapbot_mod.tscn";
