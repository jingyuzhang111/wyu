...
public static class AxebotVisualReplacePatch
{
    private const string TargetMonsterId = "AXEBOT";
    private const string CustomScenePath = "res://wyu/Scenes/creatureVisual/axebot_mod.tscn";
    ...
    private static bool Prefix(MonsterModel __instance, ref NCreatureVisuals __result)
    {
        ...
        try
        {
            ...
            if (node is Node2D rawNode)
            {
                ...
                AxebotVisualBridge bridge = new AxebotVisualBridge
                {
                    Name = rawNode.Name,
